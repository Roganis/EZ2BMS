...
export const LIFE_PRESETS: readonly LifePreset[] = [
  {
    id: 'default',
    label: 'Default',
    said: said('edit.life.default'),
    deltas: { COOL: 0.2, GOOD: 0.1, MISS: -1.8, FAIL: -4.8 },
  },
  {
    id: 'forgiving',
    label: 'Forgiving',
    said: said('edit.life.forgiving'),
    deltas: { COOL: 0.2, GOOD: 0.1, MISS: -1.5, FAIL: -3.5 },
  },
  {
    id: 'recovery',
    label: 'Fast recovery',
    said: said('edit.life.recovery'),
